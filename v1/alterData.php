    ...
    <header id="banner" class="scrollto clearfix" data-enllax-ratio=".5">
        ...
        <div id="banner-content" class="row clearfix">
                ...
                <link href="css/register.css" rel="stylesheet" type="text/css">
                    <section id="content">
                        <form action="verifyAlterData.php" method="post">
                            <?php echo Csrf::field(); ?>
                            <h1>Altareção de Dados</h1>
                                <div>
                                    <input type="text" placeholder="Nome" name="name" id="name" value="<?php echo e($currentUser['nome'] ?? ''); ?>" required>
                                </div>
                                <div>
                                    <input type="tel" placeholder="Telefone" name="tel" id="tel" value="<?php echo e($currentUser['tel'] ?? ''); ?>" required>
                                </div>
                                <div>
                                    <input type="password" placeholder="Nova senha (deixe em branco para manter)" name="password" id="password" minlength="8">
                                </div>
                                <div>
