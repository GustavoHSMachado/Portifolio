                    ...
                    <section id="content">                    
                        <form action="VerifyResetPassword.php" method="post">
                            <h1>Nova Senha</h1>
                                ...
                                <div>
                                    <input type="email" placeholder="E-mail" name="email" id="email" value="<?php echo isset($_GET['email']) ? htmlspecialchars($_GET['email']) : ''; ?>" required />
                                </div>
    
                                <div>
                                    <input type="senha" placeholder="Nova Senha" name="newSenha" id="newSenha" required />
                                </div>
                                
                                <div>
                                    <input type="senha" placeholder="Confirmar Senha" name="confirmNewSenha" id="confirmNewSenha" required />
                                </div>
