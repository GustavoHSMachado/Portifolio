...
<?php
    ...
    // Antes bastava estar logado para abrir esta página (broken access control).
    Auth::requireAdmin();
    ...
    <header id="banner" class="scrollto clearfix" data-enllax-ratio=".5">
        ...
        <div id="banner-content" class="row clearfix">
            ...
            <div class="col-38">
                ...
                <!--End Call to Action-->
                <?php
                    // Registro de acesso (auditoria) — agora via PDO e sem reabrir sessão/conexão.
                    try {
                        Database::run(
                            'INSERT INTO registros_acesso (ip_address, pagina_visitada) VALUES (?, ?)',
