    ...
    <header id="banner" class="scrollto clearfix" data-enllax-ratio=".5">
        ...
        <div id="banner-content" class="row clearfix">
                ...
                <link href="css/register.css" rel="stylesheet" type="text/css">
                    <section id="content">                    
                        <form action="VerifyResetPassword.php" method="post">
                            <?php echo Csrf::field(); ?>
                            <h1>Nova Senha</h1>

                                <div>
                                    <input type="email" placeholder="E-mail" name="email" id="email" value="<?php echo e($_GET['email'] ?? ''); ?>" readonly required />
                                    <input type="hidden" name="token" value="<?php echo e($_GET['token'] ?? ''); ?>" />
                                </div>
    
                                <div>
                                    <input type="password" placeholder="Nova Senha" name="newSenha" id="newSenha" minlength="8" required />
                                </div>
                                
                                <div>
                                    <input type="password" placeholder="Confirmar Senha" name="confirmNewSenha" id="confirmNewSenha" minlength="8" required />
                                </div>
